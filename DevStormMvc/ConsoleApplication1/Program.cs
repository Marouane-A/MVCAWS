...
namespace ConsoleApplication1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Showroomer sh = new Showroomer { Adress = add, FirstName = "Showroomer1", Location = loc };
            Showroomer sh1 = new Showroomer { Adress = add, FirstName = "Showroomer2", Location = loc };
            Showroomer sh2 = new Showroomer { Adress = add, FirstName = "Showroomer3", Location = loc };
